<?php
/**
 * Plugin Name:       AdRotater Email Ad Reports
 * Plugin URI:        http://xylusthemes.com/
 * Description:       AdRotater Email Ad Reports allow you to send monthly ad reports to advertisers.
 * Version:           1.1.0
 * Author:            Xylus Themes
 * Author URI:        http://xylusthemes.com/
 * License:           GPLv2 or later
 * Text Domain:       adrotate-email-add-on
 ...
 */
require_once plugin_dir_path( __FILE__ ) . 'includes/class-adrotate-email-add-on-activator.php';

/**
 * The code that runs during plugin deactivation.
 */
require_once plugin_dir_path( __FILE__ ) . 'includes/class-adrotate-email-add-on-deactivator.php';

/**
 * The code that required for sending E-Mails.
 */
require_once plugin_dir_path( __FILE__ ) . 'includes/class-adrotate-email-add-on-send-email.php';
 ...
 */
require_once plugin_dir_path( __FILE__ ) . 'includes/class-adrotate-email-add-on.php';
...
function self_deactivate_notice() {
    ...
    <div class="error">
	    <p>
			<?php _e("AdRotate Email Add-on has deactivated itself because AdRotate is no longer active","adrotate-email-add-on");?>
	    </p>
    </div>
<?php
}
